...
def percentage_delayed_flights_on_map(data_manager):
    result = data_manager.get_routes_average_delay()
    print(result)
...
FUNCTIONS = {1: (flight_by_id, "Show flight by ID"),
             ...
             5: (percentage_delayed_flights_on_map, "Percentage of delayed flights on a map"),
             6: (quit, "Exit")
             }
